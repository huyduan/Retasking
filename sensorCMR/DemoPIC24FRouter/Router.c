                         ...
                         case STATUS_REQUEST:
                            {
                               ...
                               // SendOneByte(MAC_LONG_ADDR_BYTE0, STATUS_RESPONSE_CLUSTER);
                                //#define USE_SHT10;
                           //undef USE_SHT10
                              //#undef USE_SHT10;
                                //SET_SHT10 = 0;
                                if (SET_SHT10 == 0){
                                    if (SET_PTC06 == 0){
                                        SendOneByte(MAC_LONG_ADDR_BYTE0, STATUS_RESPONSE_CLUSTER_PTC06_SHT10_0);                                   
                                    }
                                    else {
                                        SendOneByte(MAC_LONG_ADDR_BYTE0, STATUS_RESPONSE_CLUSTER_PTC06_1);
                                    }
                                }
                                else{
                                    if(SET_PTC06 == 0){
                                    SendOneByte(MAC_LONG_ADDR_BYTE0, STATUS_RESPONSE_CLUSTER_PTC06_MQ6_0);

                                    }
                                    else {
                                        SendOneByte(MAC_LONG_ADDR_BYTE0, STATUS_RESPONSE_CLUSTER_PTC06_SHT10_1);
                                    }
                                }
                            ...
                            break;
                            case RETASK_ENABLE_CLUSTER_PTC06_0:
                            {
                                SET_PTC06 = 0;
                            }
                            break;
                            case RETASK_ENABLE_CLUSTER_PTC06_1:
                            {
                                SET_PTC06 = 1;
                            }
                            break;
                            case RETASK_ENABLE_CLUSTER_SHT10_0:
                            {
                                SET_SHT10 = 0;
                            }
                            break;
                            case RETASK_ENABLE_CLUSTER_SHT10_1:
                            {
                                SET_SHT10 = 1;
                            }
                            break;
                            //user clusterID application
                                ...
                                {
                                   if(SET_SHT10 == 1 ){  //ban tin yeu cau lay du lieu nhiet do - do am tu bo nhung co dang: 0x00
                                    //data = APLGet();
                                   ...
                                   //SendOneByte(MAC_LONG_ADDR_BYTE0, STATUS_RESPONSE_CLUSTER);
                                       ...
                                       SendOneByte(MAC_LONG_ADDR_BYTE0, STATUS_DISABLE);
                                        #if defined(USE_DEBUG)
                                        printf(" STATUS_DISABLE\r\n");
                                    #endif
                                   }
                                }
                                    break;
