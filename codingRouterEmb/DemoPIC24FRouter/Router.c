                        ...
                        switch(params.APSDE_DATA_indication.ClusterId.Val)
                        {
                            ...
                            case HTE_AUTO_SEND_CLUSTER:
                                ...
                                case CMR_RESPONSE_CLUSTER:
                                {
                                    ...
                                    LIP = (BYTE)(IP & 0x00ff);
                                    mac = APLGet();
                                    PrintChar(mac);//Byte0 dia chi MAC
                                    PrintChar(APLGet());//2 byte do dai anh
                                    PrintChar(APLGet());
                                    packet = APLGet();
                                    PrintChar(packet);
                                    pk[mac][0]++;
                                    pk[mac][packet + 1] = packet + 1;
                                    for(i=0;i<80;i++)
                                    {  //nhan data anh
                                        test=APLGet();
                                        PrintChar(test);
                                        if(test_1==0xFF && test==0xD9)
                                        {
                                            kt = 1;
                                            break;
                                        }
                                    ...
                                    if(kt == 1)
                                    {
                                        if(pk[mac][0] > (packet/2))
                                        {
                                            ...
                                            SendOneByte(PACKET_REQUEST_CLUSTER, HIP, LIP, rpk[mac][0]);
                                        }
                                        else
                            ...
                            break;
                          case STATUS_RESPONSE_CLUSTER_PTC06_MQ6_0:
                            {
                                printf ("#SC:");
                                PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                mac = APLGet();
                                PrintChar(mac);//Byte0 dia chi MAC
                                //printf ("dang o che do lay nhiet do, do am");                               
                                printf("012");

                                printf ("\r\n");
                            }
                          break;
                          case STATUS_RESPONSE_CLUSTER_PTC06_1:
                            {
                                printf ("#SC:");
                                PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                //PrintChar(APLGet());//Byte0 dia chi MAC
                                //printf ("dang o che do chup anh");
                          ...
                          break;
                          case STATUS_RESPONSE_CLUSTER_PTC06_SHT10_0:
                            {
                                printf ("#SC:");
                                PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                //PrintChar(APLGet());//Byte0 dia chi MAC
                               // printf ("dang khong o che do lay nhiet do, do am va chup anh");
                              
                                printf ("112");
                                printf ("\r\n");
                            }
                          break;
                          case STATUS_RESPONSE_CLUSTER_PTC06_SHT10_1:
                            {
                                printf ("#SC:");
                                PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                //PrintChar(APLGet());//Byte0 dia chi MAC
                                //printf ("dang o che do lay nhiet do, do am va chup anh");
                          ...
                          break;
                            case STATUS_RESPONSE_CLUSTER_SHT10_MQ6_0:
                            {
                                  printf ("#SC:");
                                PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                //PrintChar(APLGet());//Byte0 dia chi MAC
                            ...
                            break;
                            case STATUS_RESPONSE_CLUSTER_MQ6_1:
                            {
                                  printf ("#SC:");
                                PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                //PrintChar(APLGet());//Byte0 dia chi MAC
                            ...
                            break;
                            case STATUS_RESPONSE_CLUSTER_MQ6_0:
                            {
                                  printf ("#SC:");
                                PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                //PrintChar(APLGet());//Byte0 dia chi MAC
                            ...
                            break;
                             case STATUS_RESPONSE_CLUSTER_SHT10_MQ6_1:
                            {
                                  printf ("#SC:");
                                PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                //PrintChar(APLGet());//Byte0 dia chi MAC
                        ...
                        else
                        {
                            switch(Cmd)
                            {
                                ...
                                case 0x50:// lenh bo che do lay nhiet do do am
                                    SendOneByte(RETASK_ENABLE_CLUSTER_SHT10_0, Addr_MSB, Addr_LSB, Cmd);
                                    break;
                                case 0x51:
                                    SendOneByte(RETASK_ENABLE_CLUSTER_SHT10_1, Addr_MSB, Addr_LSB, Cmd);
                                    break;
                                case 0x60:
                                    SendOneByte(RETASK_ENABLE_CLUSTER_PTC06_0, Addr_MSB, Addr_LSB, Cmd);
                                    break;
                                case 0x61:
                                    SendOneByte(RETASK_ENABLE_CLUSTER_PTC06_1, Addr_MSB, Addr_LSB, Cmd);
                                    break;
                                case 0x70:
                                    SendOneByte(RETASK_ENABLE_CLUSTER_MQ6_0, Addr_MSB, Addr_LSB, Cmd);
                                    break;
                                case 0x71:
                                    SendOneByte(RETASK_ENABLE_CLUSTER_MQ6_1, Addr_MSB, Addr_LSB, Cmd);
                                    break;
                                case 0xF1:
